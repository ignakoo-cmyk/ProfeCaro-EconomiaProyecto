...
export const GIG_CATEGORIES = [
  ...
  { id: '4', icon: Laptop, label: 'Ayuda con PC/Software', color: 'text-indigo-500' },
  { id: '5', icon: Package, label: 'Armado de Cajas', color: 'text-amber-500' },
  { id: '6', icon: Users, label: 'Staff Universitario', color: 'text-purple-500' },
